...
try:
    ...
    response = requests.get(f'https://www.hybrid-analysis.com/api/v2/latest-submissions?start={start_time}&end={end_time}&sort=score&order=desc&size=20',
    ...
    bot.send_message(chat_id=chat_id, text=f'Error occurred while fetching top 20 malicious files: {e}')
